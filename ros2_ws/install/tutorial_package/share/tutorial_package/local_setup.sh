...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/install/tutorial_package"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tutorial_package/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tutorial_package/environment/path.sh"
